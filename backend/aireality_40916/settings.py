"""
Django settings for aireality_40916 project.
...
ROOT_URLCONF = 'aireality_40916.urls'
...
WSGI_APPLICATION = 'aireality_40916.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aireality_40916 API",
    "DESCRIPTION": "API documentation for aireality_40916 App",
    "VERSION": "v1",
}
